            ...
            if (_scanner != null && _scannerCommand != null && _brokenTurret != null)
            {
                ...
                if (_isScanning)
                {
                    if (_scanningTimer < _scanningDuration)
                    {
                        ...
                        if (_avatar != null)
                        {
                            _avatar.entity.transform.Position = new Vector2(MathHelper.Lerp(_avatar.entity.transform.Position.X, entity.transform.Position.X, 0.1f), _avatar.entity.transform.Position.Y);
