    ...
    public class LoadingScreen : World
    {
            ...
            :base(game)
        {
            if (!SoundManager.MusicLock)
            {
                ...
                else if (((groupToLoad != "00TitleScreen" && levelToLoad == "00TrainingOpening") || (groupToLoad == "03WrathLevel")) && SoundManager.NextTrackName != "Drone1Loop" && SoundManager.CurrentTrackName != "Drone1Loop")
