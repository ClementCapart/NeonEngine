...
namespace NeonEngine
{
    public class RotatedRectangle
    {
        ...
        /// <summary>
        /// Used for moving the X and Y position of the RotatedRectangle
        /// </summary>
        /// <param name="theXPositionAdjustment"></param>
        /// <param name="theYPositionAdjustment"></param>
        public void MovePosition(int theXPositionAdjustment, int theYPositionAdjustment)
        {
        ...
        /// </summary>
        /// <param name="theNewPosition"></param>
        public void ChangePosition(Vector2 theNewPosition)
        {
            CollisionRectangle.X = (int)theNewPosition.X;
            CollisionRectangle.Y = (int)theNewPosition.Y;
        }
