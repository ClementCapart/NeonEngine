    ...
    public class RandomTilableGraphic : DrawableComponent
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (_verticalTiling)
            {
                ...
                {
                    if(_closerTexture != null)
                        spriteBatch.Draw(_closerTexture, new Vector2(entity.transform.Position.X, basePositionY) + Offset + _closerOffset + this._parallaxPosition + new Vector2(0, _closerTexture.Height / 2 * entity.transform.Scale), null, MainColor, _closerRotation, new Vector2(_closerTexture.Width / 2, _closerTexture.Height / 2), entity.transform.Scale, this.CloserBasicSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally, Layer);
                    if(_secondCloserTexture != null)
                        spriteBatch.Draw(_secondCloserTexture, new Vector2(entity.transform.Position.X, basePositionY + _tilingSize - _secondCloserTexture.Height / 2 * entity.transform.Scale - 2) + Offset + this._parallaxPosition, null, MainColor, _secondCloserRotation, new Vector2(_secondCloserTexture.Width / 2, _secondCloserTexture.Height / 2), entity.transform.Scale, SpriteEffects.FlipVertically | ( this.SecondCloserBasicSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally ), Layer);
                    else if(_closerTexture != null)
                        spriteBatch.Draw(_closerTexture, new Vector2(entity.transform.Position.X, basePositionY + _tilingSize - _closerTexture.Height / 2 * entity.transform.Scale - 2) + Offset + _secondCloserOffset + this._parallaxPosition, null, MainColor, _secondCloserRotation, new Vector2(_closerTexture.Width / 2, _closerTexture.Height / 2), entity.transform.Scale,   SpriteEffects.FlipVertically | (this.SecondCloserBasicSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally), Layer);
                }
            }
            else
            {
                ...
                foreach (KeyValuePair<Texture2D, List<Vector2>> kvp in _randomResult)
                {
                    foreach (Vector2 position in kvp.Value)
                    {
                        spriteBatch.Draw(kvp.Key, new Vector2(basePositionX, entity.transform.Position.Y) + Offset + this._parallaxPosition + position * entity.transform.Scale + new Vector2((_closerTexture != null ? _closerTexture.Width : (_secondCloserTexture != null ? _secondCloserTexture.Width : 0)) * entity.transform.Scale, 0), null, MainColor, 0.0f, new Vector2(0, kvp.Key.Height / 2), entity.transform.Scale, CurrentSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally, Layer);
                    }
                }
                if (_closerTexture != null || _secondCloserTexture != null)
                {
                    if(_closerTexture != null)
                        spriteBatch.Draw(_closerTexture, new Vector2(basePositionX, entity.transform.Position.Y) + Offset + _closerOffset + this._parallaxPosition + new Vector2(_closerTexture.Width / 2 * entity.transform.Scale, 0), null, MainColor, _closerRotation, new Vector2(_closerTexture.Width / 2, _closerTexture.Height / 2), entity.transform.Scale, this.CloserBasicSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally, Layer);
                    if(_secondCloserTexture != null)
                        spriteBatch.Draw(_secondCloserTexture, new Vector2(basePositionX + _tilingSize - _secondCloserTexture.Width / 2 * entity.transform.Scale - 2, entity.transform.Position.Y) + _secondCloserOffset + Offset + this._parallaxPosition, null, MainColor, _secondCloserRotation, new Vector2(_secondCloserTexture.Width / 2, _secondCloserTexture.Height / 2), entity.transform.Scale, this.SecondCloserBasicSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally, Layer);
                    else if(_closerTexture != null)
                        spriteBatch.Draw(_closerTexture, new Vector2(basePositionX + _tilingSize - _closerTexture.Width / 2 * entity.transform.Scale - 2, entity.transform.Position.Y) + Offset + _secondCloserOffset + this._parallaxPosition, null, MainColor, _closerRotation, new Vector2(_closerTexture.Width / 2, _closerTexture.Height / 2), entity.transform.Scale, this.SecondCloserBasicSide == Side.Right ? SpriteEffects.None : SpriteEffects.FlipHorizontally, Layer);
                }
            }          
