    ...
    public class RandomTilableGraphic : DrawableComponent
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            if (_verticalTiling)
            {
                ...
                {
                    if(_closerTexture != null)
                        spriteBatch.Draw(_closerTexture, new Vector2(entity.transform.Position.X, basePositionY) + Offset + this._parallaxPosition + new Vector2(0, _closerTexture.Height / 2 * entity.transform.Scale), null, MainColor, _closerRotation, new Vector2(_closerTexture.Width / 2, _closerTexture.Height / 2), entity.transform.Scale, SpriteEffects.None, Layer);
